    ...
    ColumnLayout {
        ...
        Item { // Tab indicator
            ...
            Rectangle {
                ...
                property real targetWidth: (tabBar.contentItem && tabBar.contentItem.children && tabBar.contentItem.children.length > 0 && tabBar.contentItem.children[0] && tabBar.contentItem.children[0].children && tabBar.contentItem.children[0].children[tabBar.currentIndex] && tabBar.contentItem.children[0].children[tabBar.currentIndex].tabContentWidth) ? tabBar.contentItem.children[0].children[tabBar.currentIndex].tabContentWidth : 80
