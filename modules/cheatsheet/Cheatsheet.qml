    ...
    Loader {
        ...
        sourceComponent: PanelWindow { // Window
            ...
            Rectangle {
                ...
                // Limitar tamanho ao monitor com margem de segurança
                implicitWidth: Math.min(cheatsheetColumnLayout.implicitWidth + padding * 2, cheatsheetRoot.screen.width * 0.9)
                implicitHeight: Math.min(cheatsheetColumnLayout.implicitHeight + padding * 2, cheatsheetRoot.screen.height * 0.85)
